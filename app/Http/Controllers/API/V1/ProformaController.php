...
class ProformaController extends Controller
{
    ...
    public function convertToPedido(Request $request, Proforma $proforma) { [$pedido, $created] = $this->pedidos->convertFromProforma($proforma, $request->user(), $request->validate(['fecha_entrega_estimada' => 'nullable|date', 'observaciones_internas' => 'nullable|string'])); return response()->json(['data' => ['id' => $pedido->id, 'numero' => $pedido->numero, 'estado' => $pedido->estado]], $created ? 201 : 200); }
