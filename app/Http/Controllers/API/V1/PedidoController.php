...
use App\Http\Requests\FacturarPedidoRequest;
...
class PedidoController extends Controller
{
    ...
    public function invoice(FacturarPedidoRequest $request, Pedido $pedido): \Illuminate\Http\JsonResponse { [$invoice, $created] = $this->billing->facturar($pedido, $request->user(), $request->validated()); return response()->json(['data' => new \App\Http\Resources\V1\FacturaResource($invoice)], $created ? 201 : 200); }
    ...
    private function relations(): array { return ['proforma','vendedor','factura','detalles.servicios','servicios','materiales','procesos','historial']; }
}
