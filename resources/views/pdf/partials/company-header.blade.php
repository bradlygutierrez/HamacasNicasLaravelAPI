<table class="top-rule" style="padding-top:10px; margin-bottom:18px;">
    <tr>
        <td style="width:48%; vertical-align:top;">
            ...
            <div class="muted small">{{ $company['facebook'] ?? '' }} @if(!empty($company['facebook']) && !empty($company['instagram'])) · @endif {{ $company['instagram'] ?? '' }} @if(!empty($company['youtube'])) · {{ $company['youtube'] }} @endif</div>
        </td>
