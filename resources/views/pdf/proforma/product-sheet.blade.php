...
@if($sheet['colors']) <div class="muted" style="font-size:12px; margin-top:3px;">{{ implode(' / ', $sheet['colors']) }}</div> @endif
...
<table class="avoid-break"><tr><td style="width:50%; vertical-align:top;"><ul style="margin:0; padding-left:15px;">@foreach(array_filter(['Categoría' => $sheet['category'], 'Tamaño' => $sheet['size'], 'Colores' => implode(' / ', $sheet['colors'])]) as $label => $value)<li><strong>{{ $label }}:</strong> {{ $value }}</li>@endforeach</ul></td><td style="vertical-align:top;">{{ $sheet['description'] ?: 'Sin descripción disponible.' }}</td></tr></table>
