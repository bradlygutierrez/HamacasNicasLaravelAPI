...
class PedidoApiTest extends TestCase
{
    ...
    private function acceptedProforma(Usuario $admin, Usuario $vendor): Proforma
    {
        ...
        ProformaDetalle::create(['proforma_id' => $proforma->id, 'hamaca_id' => $hamaca->id, 'receta_hamaca_id' => $recipe->id, 'receta_version_snapshot' => 3, 'hamaca_nombre_snapshot' => 'Pedido snapshot', 'cantidad' => 2, 'precio_unitario' => 1000, 'subtotal' => 2000, 'costo_unitario_estimado' => 750, 'costo_total_estimado' => 1500]);
        ProformaMaterialSnapshot::create(['proforma_id' => $proforma->id, 'origen_tipo' => 'receta', 'origen_id' => 1, 'material_id' => $material->id, 'material_nombre_snapshot' => 'Manila', 'unidad_consumo_snapshot' => 'metro', 'unidad_compra_snapshot' => 'rollo', 'cantidad_base_unitaria' => 125, 'factor_cantidad' => 2, 'porcentaje_merma' => 0, 'cantidad_total_con_merma' => 250, 'contenido_por_compra_snapshot' => 100, 'precio_compra_snapshot' => 600, 'costo_unidad_consumo_snapshot' => 6, 'costo_consumo_total' => 1500]);
        return $proforma;
    }
